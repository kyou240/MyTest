...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SubmitDoujiResponse : IEquatable<SubmitDoujiResponse>
    {
        /// <summary>
        /// Gets or Sets Results
        /// </summary>
        [DataMember(Name="results", EmitDefaultValue=false)]
        public List<SubmitDoujiResponseResults> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmitDoujiResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SubmitDoujiResponse)obj);
        }

        /// <summary>
        /// Returns true if SubmitDoujiResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SubmitDoujiResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmitDoujiResponse other)
        {
        ...
        public static bool operator ==(SubmitDoujiResponse left, SubmitDoujiResponse right)
        {
