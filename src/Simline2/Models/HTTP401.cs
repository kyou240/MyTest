...
{ 
    /// <summary>
    /// 認証エラー  ユーザIDやパスワードに誤りがある場合に返却する。 
    /// </summary>
    [DataContract]
    public partial class HTTP401 : IEquatable<HTTP401>
    {
        /// <summary>
        /// HTTPステータスコード
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HTTP401)obj);
        }

        /// <summary>
        /// Returns true if HTTP401 instances are equal
        /// </summary>
        /// <param name="other">Instance of HTTP401 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTP401 other)
        {
        ...
        public static bool operator ==(HTTP401 left, HTTP401 right)
        {
