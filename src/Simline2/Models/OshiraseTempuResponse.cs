...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OshiraseTempuResponse : IEquatable<OshiraseTempuResponse>
    {
        /// <summary>
        /// お知らせの添付ファイル。ZIP形式で圧縮されている。
        /// </summary>
        /// <value>お知らせの添付ファイル。ZIP形式で圧縮されている。</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OshiraseTempuResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OshiraseTempuResponse)obj);
        }

        /// <summary>
        /// Returns true if OshiraseTempuResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of OshiraseTempuResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OshiraseTempuResponse other)
        {
        ...
        public static bool operator ==(OshiraseTempuResponse left, OshiraseTempuResponse right)
        {
