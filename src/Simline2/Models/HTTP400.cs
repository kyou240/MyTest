...
{ 
    /// <summary>
    /// リクエストエラー  パラメータに誤りがある場合等に返却する。 
    /// </summary>
    [DataContract]
    public partial class HTTP400 : IEquatable<HTTP400>
    {
        /// <summary>
        /// HTTPステータスコード
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HTTP400)obj);
        }

        /// <summary>
        /// Returns true if HTTP400 instances are equal
        /// </summary>
        /// <param name="other">Instance of HTTP400 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTP400 other)
        {
        ...
        public static bool operator ==(HTTP400 left, HTTP400 right)
        {
