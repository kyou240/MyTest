...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CharacterTokiResponseCharacterInfos : IEquatable<CharacterTokiResponseCharacterInfos>
    {
        /// <summary>
        ...
        /// <summary>
        /// Unicode。全8桁、設定内容は以下のとおり。  - 先頭2桁：Unicodeスカラ値の先頭2桁の”U+”の部分を、”0U”（ゼロユー）固定として設定する。 - 残り6桁：Unicodeスカラ値の先頭2桁以外の16進法の値（4桁～6桁）を前ゼロ埋めして設定する。 - 【例】Unicodeスカラ値”U+123F”の場合、”0U00123F”と設定する。
        /// </summary>
        /// <value>Unicode。全8桁、設定内容は以下のとおり。  - 先頭2桁：Unicodeスカラ値の先頭2桁の”U+”の部分を、”0U”（ゼロユー）固定として設定する。 - 残り6桁：Unicodeスカラ値の先頭2桁以外の16進法の値（4桁～6桁）を前ゼロ埋めして設定する。 - 【例】Unicodeスカラ値”U+123F”の場合、”0U00123F”と設定する。</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CharacterTokiResponseCharacterInfos {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CharacterTokiResponseCharacterInfos)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Unicode != null)
                    hashCode = hashCode * 59 + Unicode.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(CharacterTokiResponseCharacterInfos left, CharacterTokiResponseCharacterInfos right)
        {
