...
{ 
    /// <summary>
    /// 単独申請送信エラーレスポンス  パラメータに誤りがある場合等に返却する。 
    /// </summary>
    [DataContract]
    public partial class SubmitTandokuErrorResponse : IEquatable<SubmitTandokuErrorResponse>
    {
        /// <summary>
        /// HTTPステータスコード
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmitTandokuErrorResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SubmitTandokuErrorResponse)obj);
        }

        /// <summary>
        /// Returns true if SubmitTandokuErrorResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SubmitTandokuErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmitTandokuErrorResponse other)
        {
        ...
        public static bool operator ==(SubmitTandokuErrorResponse left, SubmitTandokuErrorResponse right)
        {
