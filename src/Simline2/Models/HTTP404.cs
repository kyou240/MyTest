...
{ 
    /// <summary>
    /// 存在エラー  指定した対象のリソースが存在しない場合に返却する。 
    /// </summary>
    [DataContract]
    public partial class HTTP404 : IEquatable<HTTP404>
    {
        /// <summary>
        /// HTTPステータスコード
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HTTP404)obj);
        }

        /// <summary>
        /// Returns true if HTTP404 instances are equal
        /// </summary>
        /// <param name="other">Instance of HTTP404 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTP404 other)
        {
        ...
        public static bool operator ==(HTTP404 left, HTTP404 right)
        {
