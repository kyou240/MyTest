...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class OshiraseResponse : IEquatable<OshiraseResponse>
    {
        /// <summary>
        /// お知らせ区分：  - 1 ・・・ 補正通知以外 - 2 ・・・ 補正通知 
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OshiraseResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((OshiraseResponse)obj);
        }

        /// <summary>
        /// Returns true if OshiraseResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of OshiraseResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OshiraseResponse other)
        {
        ...
        public static bool operator ==(OshiraseResponse left, OshiraseResponse right)
        {
