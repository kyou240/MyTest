...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ShinseishaResponse : IEquatable<ShinseishaResponse>
    {
        /// <summary>
        /// 氏名
        /// </summary>
        /// <value>氏名</value>
        [Required]
        [DataMember(Name="shimei", EmitDefaultValue=false)]
        ...
        /// <value>氏名カナ</value>
        [Required]
        [DataMember(Name="shimeiKana", EmitDefaultValue=false)]
        public string ShimeiKana { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShinseishaResponse {\n");
            sb.Append("  Shimei: ").Append(Shimei).Append("\n");
            sb.Append("  ShimeiKana: ").Append(ShimeiKana).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ShinseishaResponse)obj);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Shimei != null)
                    hashCode = hashCode * 59 + Shimei.GetHashCode();
                    if (ShimeiKana != null)
                    hashCode = hashCode * 59 + ShimeiKana.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ShinseishaResponse left, ShinseishaResponse right)
        {
