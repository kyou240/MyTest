...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SubmitTandokuResponse : IEquatable<SubmitTandokuResponse>
    {
        /// <summary>
        /// 申請案件の最終更新日時
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmitTandokuResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SubmitTandokuResponse)obj);
        }
        ...
        public static bool operator ==(SubmitTandokuResponse left, SubmitTandokuResponse right)
        {
