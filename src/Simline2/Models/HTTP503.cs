...
{ 
    /// <summary>
    /// サービス時間外エラー  サービス時間外の際に返却する。 
    /// </summary>
    [DataContract]
    public partial class HTTP503 : IEquatable<HTTP503>
    {
        /// <summary>
        /// HTTPステータスコード
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HTTP503)obj);
        }

        /// <summary>
        /// Returns true if HTTP503 instances are equal
        /// </summary>
        /// <param name="other">Instance of HTTP503 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTP503 other)
        {
        ...
        public static bool operator ==(HTTP503 left, HTTP503 right)
        {
