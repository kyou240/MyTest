...
{ 
    /// <summary>
    /// サーバエラー  サーバ内でエラーが発生した場合に返却する。   
    /// </summary>
    [DataContract]
    public partial class HTTP500 : IEquatable<HTTP500>
    {
        /// <summary>
        /// HTTPステータスコード
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HTTP500)obj);
        }

        /// <summary>
        /// Returns true if HTTP500 instances are equal
        /// </summary>
        /// <param name="other">Instance of HTTP500 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTP500 other)
        {
        ...
        public static bool operator ==(HTTP500 left, HTTP500 right)
        {
