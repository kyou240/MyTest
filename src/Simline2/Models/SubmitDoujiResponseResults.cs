...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SubmitDoujiResponseResults : IEquatable<SubmitDoujiResponseResults>
    {
        /// <summary>
        /// 申請案件の最終更新日時。最後の申請案件の送信時に全ての申請案件分値が設定される。
        /// </summary>
        ...
        /// </summary>
        /// <value>申請案件の申請番号。最後の申請案件の送信時に全ての申請案件分値が設定される。</value>
        [Required]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmitDoujiResponseResults {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SubmitDoujiResponseResults)obj);
        }

        /// <summary>
        /// Returns true if SubmitDoujiResponseResults instances are equal
        /// </summary>
        /// <param name="other">Instance of SubmitDoujiResponseResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmitDoujiResponseResults other)
        {
        ...
        public static bool operator ==(SubmitDoujiResponseResults left, SubmitDoujiResponseResults right)
        {
