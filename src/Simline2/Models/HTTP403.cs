...
{ 
    /// <summary>
    /// アクセス禁止エラー  アクセスが許可されていない場合に返却する。 
    /// </summary>
    [DataContract]
    public partial class HTTP403 : IEquatable<HTTP403>
    {
        /// <summary>
        /// HTTPステータスコード
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((HTTP403)obj);
        }

        /// <summary>
        /// Returns true if HTTP403 instances are equal
        /// </summary>
        /// <param name="other">Instance of HTTP403 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HTTP403 other)
        {
        ...
        public static bool operator ==(HTTP403 left, HTTP403 right)
        {
