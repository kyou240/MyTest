...
{ 
    /// <summary>
    /// 登記識別情報通知・未失効回答取得済み通知レスポンス
    /// </summary>
    [DataContract]
    public partial class MishikkouDeleteResponse : IEquatable<MishikkouDeleteResponse>
    {
        /// <summary>
        /// 申請案件の最終更新日時
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MishikkouDeleteResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MishikkouDeleteResponse)obj);
        }
        ...
        public static bool operator ==(MishikkouDeleteResponse left, MishikkouDeleteResponse right)
        {
