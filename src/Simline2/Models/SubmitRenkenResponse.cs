...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class SubmitRenkenResponse : IEquatable<SubmitRenkenResponse>
    {
        /// <summary>
        /// Gets or Sets Results
        /// </summary>
        [DataMember(Name="results", EmitDefaultValue=false)]
        public List<SubmitRenkenResponseResults> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubmitRenkenResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((SubmitRenkenResponse)obj);
        }

        /// <summary>
        /// Returns true if SubmitRenkenResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of SubmitRenkenResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubmitRenkenResponse other)
        {
        ...
        public static bool operator ==(SubmitRenkenResponse left, SubmitRenkenResponse right)
        {
